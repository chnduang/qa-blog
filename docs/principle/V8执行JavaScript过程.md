...
> 本文首发于政采云前端团队博客：V8 执行 JavaScript 的过程
>
> https://www.zoo.team/article/the-process-of-executing-js-in-v8

## V8 执行 JavaScript 过程

![图片](https://mmbiz.qpic.cn/mmbiz_png/vzEib9IRhZD52rKmouXnSsVzO65Ba04It86WOyeuXZJvEbWr9zjic1N6GWNJmOicjicicX650MBEZXoE03N84PwAtSg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/vzEib9IRhZD52rKmouXnSsVzO65Ba04Ith5E0brGxzGxpjBPRQkSCwlPsQ119g3Fm3H4TC532WbtusoBzzicTT4w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
V8 所做的事情，远远不止这些，这里也仅仅是简单概况和分析一下主流程上所做的一些事情，如果细化到每个点，还有很多概念，比如内联缓存、隐藏类、快属性、慢属性、创建对象，以及笔者之前写的 [**V8 引擎垃圾回收与内存分配**](http://mp.weixin.qq.com/s?__biz=MzI0NTE5NzYyMw==&mid=2247484919&idx=1&sn=a748fc841488d9afb15633e0046bea66&chksm=e9537bafde24f2b99cde0fb1921806e890a8930aade53a6f9e71c9b84aeaef5d39d2765a794f&scene=21#wechat_redirect) 等等，所做的事情实在太多，就不一一例举了。