...
### [#](http://www.conardli.top/docs/JavaScript/EventEmitter.html#观察者模式的优点)观察者模式的优点
...
## [#](http://www.conardli.top/docs/JavaScript/EventEmitter.html#nodejs的eventemitter)Nodejs的EventEmitter
...
### [#](http://www.conardli.top/docs/JavaScript/EventEmitter.html#api)Api
...
### [#](http://www.conardli.top/docs/JavaScript/EventEmitter.html#基本使用)基本使用
...
## [#](http://www.conardli.top/docs/JavaScript/EventEmitter.html#手动实现eventemitter)手动实现EventEmitter
...
## [#](http://www.conardli.top/docs/JavaScript/EventEmitter.html#javascript自定义事件)JavaScript自定义事件
