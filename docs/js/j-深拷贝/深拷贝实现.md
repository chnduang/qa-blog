...
## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#导读)导读
...
## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#深拷贝和浅拷贝的定义)深拷贝和浅拷贝的定义

深拷贝已经是一个老生常谈的话题了，也是现在前端面试的高频题目，但是令我吃惊的是有很多同学还没有搞懂深拷贝和浅拷贝的区别和定义。例如前几天给我提`issue`的同学：

![img](https://i.loli.net/2019/08/30/8U5e2I6lmzBHcW9.jpg)
...
![img](https://i.loli.net/2019/08/30/N3CB7obYhn5Lvxz.jpg)

> 创建一个新对象，这个对象有着原始对象属性值的一份精确拷贝。如果属性是基本类型，拷贝的就是基本类型的值，如果属性是引用类型，拷贝的就是内存地址 ，所以如果其中一个对象改变了这个地址，就会影响到另一个对象。

深拷贝：

![img](https://i.loli.net/2019/08/30/OFIGRqZeWkBn9cr.jpg)

> 将一个对象从内存中完整的拷贝一份出来,从堆内存中开辟一个新的区域存放新对象,且修改新对象不会影响原对象

话不多说，浅拷贝就不再多说，下面我们直入正题：

## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#乞丐版)乞丐版
...
## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#基础版本)基础版本
...
![img](https://i.loli.net/2019/08/31/Nxr21XJnVgqOTs5.png)

这是一个最基础版本的深拷贝，这段代码可以让你向面试官展示你可以用递归解决问题，但是显然，他还有非常多的缺陷，比如，还没有考虑数组。

## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#考虑数组)考虑数组
...
## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#循环引用)循环引用
...
![img](https://i.loli.net/2019/08/31/JMiLz6qt2BYdvjm.png)

很明显，因为递归进入死循环导致栈内存溢出了。

原因就是上面的对象存在循环引用的情况，即对象的属性间接或直接的引用了自身的情况：

![img](https://i.loli.net/2019/09/01/uYyaqztP23xh5Vf.jpg)
...
![img](https://i.loli.net/2019/09/01/AWrneLyJavhTfOG.jpg)
...
## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#性能优化)性能优化

在上面的代码中，我们遍历数组和对象都使用了`for in`这种方式，实际上`for in`在遍历时效率是非常低的，我们来对比下常见的三种循环`for、while、for in`的执行效率：

![img](https://i.loli.net/2019/08/29/1ydBJ63LntlvZWO.jpg)
...
![img](https://i.loli.net/2019/08/31/ZhMxNjFE9KYqH7l.jpg)

很明显，我们的性能优化是有效的。

到这里，你已经向面试官展示了，在写代码的时候你会考虑程序的运行效率，并且你具有通用函数的抽象能力。

## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#其他数据类型)其他数据类型

在上面的代码中，我们其实只考虑了普通的`object`和`array`两种数据类型，实际上所有的引用类型远远不止这两个，还有很多，下面我们先尝试获取对象准确的类型。

### [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#合理的判断引用类型)合理的判断引用类型
...
### [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#获取数据类型)获取数据类型
...
![img](https://i.loli.net/2019/09/01/wvJgxWe17RdaEHY.jpg)
...
### [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#可继续遍历的类型)可继续遍历的类型
...
![img](https://i.loli.net/2019/09/01/dQ7hGjYirkRlN3s.jpg)

没有问题，里大功告成又进一步，下面我们继续处理其他类型：

### [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#不可继续遍历的类型)不可继续遍历的类型
...
### [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#克隆函数)克隆函数
...
![img](https://i.loli.net/2019/09/01/3tsUZR561FYOuQc.jpg)

## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#最后)最后

为了更好的阅读，我们用一张图来展示上面所有的代码：

![img](https://i.loli.net/2019/08/30/9lfDPCXBagE8rQY.jpg)
...
## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#参考)参考

- [WeakMap](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/WeakMap)
- [lodash](https://lodash.com/)

## [#](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#小结)小结
...
Last Updated: 9/3/2019, 8:50:45 PM

← [你真的掌握变量和类型了吗（二）类型转换](http://www.conardli.top/blog/article/JS进阶/你真的掌握变量和类型了吗（二）类型转换.html)[setState的执行机制 ](http://www.conardli.top/blog/article/React深入系列/setState的执行机制.html)→[ConardLi的blog](http://www.conardli.top/blog/)

[文章目录](http://www.conardli.top/blog/article/)

[博客 ](http://www.conardli.top/)
...
- JS进阶 
  ...
  - 如何写出一个惊艳面试官的深拷贝
    - [导读](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#导读)
    - [深拷贝和浅拷贝的定义](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#深拷贝和浅拷贝的定义)
    - [乞丐版](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#乞丐版)
    - [基础版本](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#基础版本)
    - [考虑数组](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#考虑数组)
    - [循环引用](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#循环引用)
    - [性能优化](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#性能优化)
    - 其他数据类型
      - [合理的判断引用类型](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#合理的判断引用类型)
      - [获取数据类型](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#获取数据类型)
      - [可继续遍历的类型](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#可继续遍历的类型)
      - [不可继续遍历的类型](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#不可继续遍历的类型)
      - [克隆函数](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#克隆函数)
    - [最后](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#最后)
    - [参考](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#参考)
    - [小结](http://www.conardli.top/blog/article/JS进阶/如何写出一个惊艳面试官的深拷贝.html#小结)
- React深入系列 
- 多端开发 
- 浏览器和网络 
- 浏览器策略 
