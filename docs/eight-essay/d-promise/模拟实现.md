...
## [#](http://www.conardli.top/docs/JavaScript/模拟实现promise.html#then方法)then方法
...
## [#](http://www.conardli.top/docs/JavaScript/模拟实现promise.html#then方法异步调用)then方法异步调用
...
## [#](http://www.conardli.top/docs/JavaScript/模拟实现promise.html#then方法链式调用)then方法链式调用
...
## [#](http://www.conardli.top/docs/JavaScript/模拟实现promise.html#catch方法)catch方法
...
## [#](http://www.conardli.top/docs/JavaScript/模拟实现promise.html#finally方法)finally方法
...
## [#](http://www.conardli.top/docs/JavaScript/模拟实现promise.html#promise-resolve)Promise.resolve
...
## [#](http://www.conardli.top/docs/JavaScript/模拟实现promise.html#promise-reject)Promise.reject
...
## [#](http://www.conardli.top/docs/JavaScript/模拟实现promise.html#all方法)all方法
