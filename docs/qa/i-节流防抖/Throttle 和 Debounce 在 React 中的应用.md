...
### [#](https://muyiy.cn/blog/7/7.3.html#例子-2)例子 2
...
注：原文自定义实现的节流函数有问题，节流函数的详细实现和解析可以查看我的另一篇文章，[点击查看](https://link.juejin.im/?target=https%3A%2F%2Fgithub.com%2Fyygmind%2Fblog%2Fissues%2F38)
