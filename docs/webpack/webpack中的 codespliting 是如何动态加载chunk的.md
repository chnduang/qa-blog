# webpack中的 codespliting 是如何动态加载chunk的

可点击此处查看[示例或实践代码(opens new window)](https://github.com/shfshanyue/node-examples/blob/master/engineering/webpack/code-spliting/build.js)

<iframe src="https://player.bilibili.com/player.html?bvid=BV1k44y1h7DW" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="allowfullscreen" style="width: 684px; aspect-ratio: 4 / 3; margin: 1rem 0px;"></iframe>
